 ...
 */
const NON_GOAL_SHIFT_SIGNAL_TYPES = new Set([
    'appraisal_concern',
    'email_complained',
    'email_unsubscribed',
    'email_bounced',
 ...
 */
const NON_GOAL_SHIFT_SIGNAL_PREFIXES = [
    'agent_action.',
    'deal_distress.',
    'compliance.',
];
function isNonGoalShiftSignal(signalType) {
    if (NON_GOAL_SHIFT_SIGNAL_TYPES.has(signalType))
        return true;
